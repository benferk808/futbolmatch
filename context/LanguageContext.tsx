...
const en = {
  ...
  "addExtraSlot": "Add Substitute",
  "removeExtraSlot": "Remove Substitute",
  ...
  "substituteBench": "Substitute Bench",
  "footerText": "FUTBOLMATCH © 2025",
  "creatingMatch": "Creating match...",
  "matchCreated": "Match created successfully!",
  "mapsLink": "Google Maps Link",
  "optional": "optional",
  "opponent": "Opponent",
  "opponentPlaceholder": "e.g., Los Amigos FC",
  ...
  "downloadImage": "Download Lineup",
  "downloadImageDescription": "Team image",
...
const es = {
  ...
  "addExtraSlot": "Añadir Suplente",
  "removeExtraSlot": "Quitar Suplente",
  ...
  "extraSlotAdded": "Suplente añadido al banco.",
  "extraSlotRemoved": "Suplente eliminado del banco.",
  ...
  "whatsAppShareMessage": "⚽ *¡Bienvenido a FUTBOLMATCH!* ⚽\n\n📋 *Sumate a la lista de jugadores:*\n{link}\n\n📊 *Datos del partido:*\n📅 *Fecha:* {date}\n⏰ *Hora:* {time}\n🏟️ *Cancha:* {fieldName}{opponentSection}{locationSection}",
  "whatsAppOpponentSection": "\n⚔️ *Rival:* {opponent}",
  "whatsAppLocationSection": "\n📍 *Ubicación:* {location}{mapsLinkSection}",
  "whatsAppMapsLinkSection": "\n🗺️ *Google Maps:* {mapsLink}",
  ...
  "substituteBench": "Banco de Suplentes",
  "footerText": "FUTBOLMATCH © 2025",
  ...
  "optional": "opcional",
  "opponent": "Rival",
  "opponentPlaceholder": "Ej: Los Amigos FC",
  ...
  "downloadImage": "Descargar Alineación",
  "downloadImageDescription": "Imagen del equipo",
