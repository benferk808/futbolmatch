      ...
      {isJoinModalOpen && (
        <Modal onClose={() => setJoinModalOpen(false)}>
          ...
          <input
            type="text"
            value={newPlayerName}
            onChange={e => setNewPlayerName(e.target.value.slice(0, 10))}
            maxLength={10}
          ...
          />
          <p className="text-xs text-gray-400 mt-1">Máximo 10 caracteres ({newPlayerName.length}/10)</p>
