    ...
    <Modal onClose={onClose}>
      ...
      <div className="bg-purple-900 bg-opacity-50 border border-purple-500 rounded-lg p-4 mb-4">
        ...
        <div className="flex gap-2">
          ...
          />
          <button
            onClick={() => copyToClipboard(organizerLink, true)}
      ...
      <div className="bg-green-900 bg-opacity-50 border border-green-500 rounded-lg p-4 mb-6">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="font-bold text-green-300">{t('playerLinkTitle') || 'Link para JUGADORES'}</span>
        </div>
        <p className="text-xs text-green-300 mb-2">{t('playerLinkDescription') || 'Comparte este link en el grupo de WhatsApp'}</p>
        <div className="flex gap-2">
          <input
            type="text"
            value={playerLink}
